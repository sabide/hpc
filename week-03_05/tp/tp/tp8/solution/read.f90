PROGRAM read
  ...
  CALL MPI_FILE_GET_SIZE(fh, file_size)
  CALL MPI_TYPE_CREATE_F90_REAL(precision(u_read),range(u_read),typedp)
  CALL MPI_TYPE_SIZE(typedp, double_size)
